...
resourcegroup_name = 'chk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'chk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
cars = Entity()
cars.PartitionKey = 'toyota'
cars.RowKey = '001'
cars.description = 'camry'
cars.cost = 18
...
coffee.item = 'capucheeno'
coffee.cost = 4.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for a capucheeno...\n')
time.sleep(1)
...
coffee.cost = 1.99
table_service.insert_entity('itemstable', coffee)
print('Created entry for regular...\n')
time.sleep(1)
...
items = table_service.query_entities('itemstable', filter="PartitionKey eq 'toyota'", select='description,cost')
for item in items:
